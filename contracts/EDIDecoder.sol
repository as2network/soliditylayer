...
// @title EDI Data Structure Decoder
...
library EDIDecode {
  ...
  /*
   * @dev Get the root node. First step in traversing an EDI structure
   * @param der The DER-encoded EDI structure
  ...
  /*
   * @dev Get the root node of an EDI structure that's within a bit string value
   * @param der The DER-encoded EDI structure
   * @return A pointer to the outermost node
   */
  ...
  /*
   * @dev Get the root node of an EDI structure that's within an octet string value
   * @param der The DER-encoded EDI structure
   * @return A pointer to the outermost node
   */
   ...
   * @param i Pointer to an EDI node
   * @param j Pointer to another EDI node of the same EDI structure
